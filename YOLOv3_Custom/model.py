...
"U" is for upsampling the feature map and cincatenating with a previous layer
'''
...
class ScalePrediction(nn.Module):
    ...
    def forward(self, x):
        return(
            ...
            .permute(0, 1, 3, 4, 2)  # (batch_size, anchors, height, width, classes+5)
        )
    ...
    def forward(self, x):
        ...
        for layer in self.layers:
            ...
            if isinstance(layer, ResidualBlock) and layer.num_repeats == 8:
                ...
                x = torch.cat([x, route_connections[-1]], dim=1)  # concatenate  2 times
